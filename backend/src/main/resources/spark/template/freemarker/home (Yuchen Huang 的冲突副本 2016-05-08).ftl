...
<div data-role="page" id="error-page">
  ...
  <div data-role="main" class="ui-content centered">
    <h2>Error<h2>
    <p style="font-size: 1.1em">Opps! It seems that there is a server error. We're deeply sorry for this and will fixed it as soon as possibile. Please click the click below to continue your CreditMe experience.</p>
  </div>
...
<div data-role="page" id="profile-page">
  ...
  <div data-role="main" class="ui-content centered">
    ...
    <a href="#" id="logout-submit" value="Log Out" data-role="none" class="ui-btn" style="margin-top: 20px">Log Out</a>
  </div>
...
<!--       <li id="hist-id">
    ...
    <a href="#" id="hist-more-div" class="ui-btn ui-shadow ui-icon-arrow-d ui-btn-icon-left ui-corner-all" style="float:right; margin-top: -30px; opacity: 0.8; display: none">More</a>
  </div>
