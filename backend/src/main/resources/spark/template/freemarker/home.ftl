...
<div data-role="page" id="login-page">
  ...
  <div data-role="main" class="ui-content centered">
    <label style="font-size: 1.4em; font-weight: bold; margin-bottom: 0px" id="join-label">Log In</label>
    <form id="login-form">
...
<div data-role="page" id="profile-page">
  ...
  <div data-role="main" class="ui-content centered">
    ...
    <div id="profile-contact" class="profile-info" style="color: grey">Please enter your phone number</div>
    <div id="profile-error" style="color: red; margin-top: 5px"></div>
...
<!--     <ul data-role="listview" style="padding-top: 30px">
  ...
  <div data-role="navbar">
    <ul id="bottom_ul">
      ...
      <li><a href="#profile-page" style="padding:0;background-color: #FFCAD4"><img src="../image/me.png" width="30%"><p>Me</p></a></li>
...
<div data-role="page" id="orders-page">
  ...
  <div data-role="main" class="ui-content centered">
    <h2>Orders</h2>
    <h3 id="uncommented-label">To Rate</h3>
    <p>Please rate and comment on the following deals. </p>
<!--     <p>Please leave your comment for the following deals</p> -->
    <ul data-role="listview" style="padding-top: 20px; padding-bottom: 10px" id="uncommented-ul" style="text-align: left">
    ...
    <h3 stype="padding-top: 40px; margin-top: 10px" id="curr-label">Pending</h3>
...
<li><a href="#page_buy_1" style="padding:0"><img src="../image/buy.png" width="30%"><p>Buy</p></a></li>
      		...
      		<li><a href="#orders-page" style="padding:0;background-color: #FFCAD4"><img src="../image/orders.png" width="30%"><p class="alert-p">Orders</p></a></li>
      		<li><a href="#profile-page" style="padding:0"><img src="../image/me.png" width="30%"><p>Me</p></a></li>
    	</ul>
  	</div>
  </div>
...
<div data-role="page" id="page_market">
  ...
  <div data-role="main" class="ui-content">
    ...
    <div data-role="navbar">
      <ul id="bottom_ul">
        <li><a href="#page_market" style="padding:0;background-color: #FFCAD4"><img src="../image/market.png" width="30%"><p>Market</p></a></li>
        <li><a href="#page_buy_1" style="padding:0"><img src="../image/buy.png" width="30%"><p>Buy</p></a></li>
...
<div data-role="page" id="page_buy_1">
  ...
  <div data-role="main" class="ui-content">
    ...
    <h2 style="color:black;text-align: center;font-size: 20px;font-family: Arial">Buy Food</h2>
    <ul data-role="listview" data-inset="true">
      ...
      <li>
        ...
        <h2>Delivery</h2>
        <p style="white-space:normal;">Have a credit provider deliver to a place of your choice.</p>
        </a>
  ...
  <div data-role="footer" data-tap-toggle="false" data-id="foo1" data-position="fixed" data-id="persistent">
    <div data-role="navbar">
      <ul id="bottom_ul">
        <li><a href="#page_market" style="padding:0"><img src="../image/market.png" width="30%"><p>Market</p></a></li>
        <li><a href="#page_buy_1" style="padding:0;background-color: #FFCAD4"><img src="../image/buy.png" width="30%"><p>Buy</p></a></li>
  ...
  <div data-role="main" class="ui-content">
    <div class="ui-grid-a">
      <div class="ui-block-a" style="width:15%">
        <a href="#" data-rel="back" class="back"><img style="margin:8px" src="../image/back.png"></a>
      </div>
    ...
    <a href="#page_buy_2" class="ui-btn" id="address_confirm" style="background-color:#FFCAD4;color:black;display: none">Continue</a>
  </div>
...
<div class="logo" data-role="header" data-id="persistent" data-position="fixed" style="background-color: #FFCAD4">
  ...
  <div data-role="main" class="ui-content">
    ...
    <ul data-role="listview" data-inset="true">
      <li data-role="divider">Pick a currently open eatery.</li>
      <li>
        <a href="#page_buy_3" class="andrews">
        <img src="../image/andrews.png">
        <h2>Andrews Commons</h2>
        <p style="white-space:normal;">They say some eat at Andrews 24/7.</p>
        </a>
      </li>
      ...
      <li>
        ...
        <h2>Josiah's</h2>
        <p style="white-space:normal;">Spice with? Spice without?</p>
        </a>
...
<div data-role="page" id="page_buy_3">
  ...
  <div data-role="main" class="ui-content">
    ...
    <a href="#page_buy_4" class="ui-btn ui-disabled" id="menu_confirm" style="background-color:#FFCAD4;color:black;">Continue</a>
...
<div id="page_buy_4" data-role="page">
  ...
  <div data-role="main" class="ui-content">
      ...
      <div class="full_width">
        ...
        <p style="color:#FF3232" id="payment_suggestion">tap to view suggestion</p>
        <p style="display: none" id="payment_suggestion_detail">Sellers usually offer a 10% discount off your purchase. Please choose a reasonable price and we will help you match with the sellers.</p>
   ...
   <div data-role="page" id="page_sell_1">
    ...
    <div class="logo" data-role="header" data-id="persistent" data-position="fixed" style="background-color: #FFCAD4">
      ...
      <div data-role="main" class="ui-content">
        ...
        <h2 style="color:black;text-align: center;font-size: 20px;font-family: Arial">Sell Credit</h2>
        <ul data-role="listview" data-inset="true">
          <li>
          ...
          <li>
            ...
            <h2>Meet + Deliver</h2>
            <p style="white-space:normal; ">Besides meet-up, I can also deliver food.</p>
            </a>
          </li>
    ...
    <div data-role="footer" data-tap-toggle="false" data-id="foo1" data-position="fixed" data-id="persistent">
      <div data-role="navbar">
        <ul id="bottom_ul">
          ...
          <li><a href="#page_sell_1" style="padding:0;background-color: #FFCAD4"><img src="../image/sell.png" width="30%"><p>Sell</p></a></li>
          <li><a href="#orders-page" style="padding:0"><img src="../image/orders.png" width="30%"><p class="alert-p">Orders</p></a></li>
          <li><a href="#profile-page" style="padding:0"><img src="../image/me.png" width="30%"><p>Me</p></a></li>
  ...
  <div data-role="page" id="page_sell_deliver">
    ...
    <div class="logo" data-role="header" data-id="persistent" data-position="fixed" style="background-color: #FFCAD4">
      ...
      <div data-role="main" class="ui-content">
        ...
        <a href="#page_sell_2" class="ui-btn" id="address_confirm_sell" style="background-color:#FFCAD4;color:black;display: block;margin-top: 20px;">Continue</a>
  ...
  <div data-role="page" id="page_sell_2">
    ...
    <div class="logo" data-role="header" data-id="persistent" data-position="fixed" style="background-color: #FFCAD4">
      ...
      <div data-role="main" class="ui-content">
        ...
        <a href="#page_sell_3" class="ui-btn" id="menu_confirm_sell" style="background-color:#FFCAD4;color:black;display: none;margin-top: 30px">Continue</a>
      </div>
    ...
    <div class="logo" data-role="header" data-id="persistent" data-position="fixed" style="background-color: #FFCAD4">
      ...
      <div data-role="main" class="ui-content">
        ...
        <div class="full_width">
          ...
          <label style="margin-bottom: 20px;margin-top: 20px;" for="bound">How much would you like to sell a credit for?</label>
           <input type="range" name="bound_sell" id="bound_sell" value="6.0" min="0" max="7.3" step="0.1">
          <p style="color:#FF3232;" id="payment_suggestion_sell">tap to view suggestion</p>
...
<li><a href="#page_buy_1" style="padding:0"><img src="../image/buy.png" width="30%"><p>Buy</p></a></li>
  ...
  <div data-role="page" id="page_confirm_false">
    ...
    <div data-role="main" class="ui-content">
      ...
      <div>
        <p>You have no match at this moment.</p> 
        <p>Please patiently wait. We will send mail to <span id="suggestion_mail" style="color:rgba(198,26,102,0.7)"></span> once there is a deal match.</p>
      </div>
  ...
  <div data-role="page" id="page_taken">
    ...
    <div data-role="main" class="ui-content">
      ...
      <h2>Congrats!</h2>
      <h2>Your order has just been matched and it is a better deal than the one you just confirmed!</h2>
      <h2>Go to orders page to check it out and refer to email for more information.</h2>
