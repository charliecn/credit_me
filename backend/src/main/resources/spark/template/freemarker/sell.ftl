  ...
  <div data-role="page" id="page_sell_deliver">
    <div class="logo" data-role="header" data-id="persistent" data-position="fixed" style="background-color: #FFCAD4">
      ...
      <div data-role="main" class="ui-content">
        ...
        <a href="#page_sell_2" class="ui-btn" id="address_confirm" style="background-color:#FFCAD4;color:#9D8189;display: block;margin-top: 20px;">Continue</a>
  ...
  <div data-role="page" id="page_sell_2">
    ...
    <div class="logo" data-role="header" data-id="persistent" data-position="fixed" style="background-color: #FFCAD4">
      ...
      <div data-role="main" class="ui-content">
        ...
        <a href="#page_sell_3" class="ui-btn" id="menu_confirm" style="background-color:#FFCAD4;color:#9D8189;display: none;margin-top: 30px">Continue</a>
      </div>
    ...
    <div class="logo" data-role="header" data-id="persistent" data-position="fixed" style="background-color: #FFCAD4">
      ...
      <div data-role="main" class="ui-content">
        ...
        <div class="full_width">
          ...
          <p style="color:#9d8189;" id="payment_suggestion">tap to view suggestion</p>
          <p style="display: none" id="payment_suggestion_detail">Meal credits are usually traded at 10-15% off. Pick an ideal price to prompt your deal to finish.</p>
         <input type="range" name="bound" id="bound" value="6.0" min="0" max="7.3" step="0.1">
        ...
        <div style="margin-bottom: 30px" id="credit_number">
          ...
          <label>
              <input type="radio" data-mini="true" name="creditNum" id="credit_one" value=1>One
          </label>

          <label for="radio-choice-0b">Two
              <input type="radio" data-mini="true" name="creditNum" id="credit_two" class="custom" value=2 checked>
          </label>
        ...
        <div style="margin-bottom: 30px" class="full_width">
          ...
          <input style="height: 40px;" type="tel" data-clear-btn="true" name="tel-1" id="tel-1" value="" placeholder="buyer needs to contact you" >
        ...
        <div>
          <label style="margin-bottom: 20px;margin-top: 20px;" for="duration">How long can you wait for your offer to be matched? (minutes)</label>
