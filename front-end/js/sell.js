...
$( document ).on( "pageshow", "#page_sell_3", function(event) {
	...
	$("#final_confirm").click(function(){
	    ...
	    if(phone.match(/\d/g).length===10 && phone.length==10){
	     ...
	     $.post("/placeoffer",{user:email,address:offer.address,eatery:offer.eatery,menu:offer.menu,duration:offer.duration,price:offer.price,priceBound:offer.bound,},function(response){
